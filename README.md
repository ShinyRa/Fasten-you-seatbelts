...
Mijn eerste project van het HvA. 
In dit project hebben we een website gebouwd in javascript, html/css.
We hebben een website gemaakt waar mensen een "travel buddy" kunnen vinden. 
Bij het aanmaken van een account geeft de gebruiker zijn/haar intresses op en op basis hiervan worden potentiele reisbuddies voorgesteld. Wanneer gebruikers elkaar bevrienden, is het mogelijk om in gesprek te gaan met deze persoon middels een live chat.
